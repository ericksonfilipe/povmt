	...
	<body>
		...
		<div id="show-usuario" class="content scaffold-show" role="main">
			...
			<ol class="property-list usuario">
				...
				<g:if test="${usuarioInstance?.atividades}">
				<li class="fieldcontain">
					<span id="atividades-label" class="property-label"><g:message code="usuario.atividades.label" default="Atividades" /></span>
					
						<g:each in="${usuarioInstance.atividades}" var="a">
